...
//   const isChecked = async (event, productId, productCod) => {
//     const tableRow = document.getElementById(`${productId}`);
//     const celdasTabla = tableRow.children;
//     const codigo = celdasTabla[0].firstChild;

//     console.log(codigo.textContent);
//     console.log(JSON.stringify(productCod));

//     const res = await getProduct(productId);
//     if (res !== null && codigo.textContent === productCod) {
...
//                       sx={{ "& .MuiSvgIcon-root": { fontSize: 28 } }}
//                       onChange={(event) =>
//                         isChecked(event, product.id, product.codigo)
//                       }
//                     />
//                   </TableCell>
//                 </TableRow>
